...
int data = 51;    // DIN pin del modulo MAX7219
int load = 53;    // CS pin del modulo MAX7219
int clock = 52;  // CLK pin del modulo MAX7219 

int maxInUse = 1;    //Numero de matrices usada !!!!
...
void setup(){
  pinMode(51,OUTPUT);       //Conexion a DIN
  pinMode(52,OUTPUT);       //Conexion a CS
  pinMode(52,OUTPUT);      //Conexion a CLK
...
void loop(){
  ...
  printStringWithShift(c, 80);       // El ultimo termino se usa para la velocidad del mensaje 
